...
description: Генерация референсных изображений для сайта — по одной горизонтальной картинке на каждую секцию, единая палитра, разные композиции и масштабы hero. Только картинки, не код.
---
