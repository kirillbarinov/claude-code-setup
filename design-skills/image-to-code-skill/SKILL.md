---
name: image-to-code
description: Сначала сгенерировать дизайн-картинки посекционно, разобрать их, затем сверстать страницу под них. Крупные читаемые изображения, чистый просторный hero, без вложенных карточек.
---
