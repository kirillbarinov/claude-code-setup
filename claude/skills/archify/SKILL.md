---
name: archify
description: Схемы архитектуры, workflow, sequence, data flow и state machine как автономный HTML с inline SVG, темами и экспортом PNG/SVG/WebM. Также конвертация Mermaid. Вызывать, когда предмет — устройство системы.
license: MIT
metadata:
  version: "2.17"
  author: tt-a1i
